...
public class Detalle_Contacto extends AppCompatActivity {
        ...
        Llamar_C.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(Detalle_Contacto.this,
                    ...
                    SolicitudPermisoLlamada.launch(android.Manifest.permission.CALL_PHONE);
                }
            }
        });
        Mensaje_C.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(Detalle_Contacto.this,
                    ...
                    SolicitudPermisoMensaje.launch(android.Manifest.permission.SEND_SMS);
                }
            }
        });
    }
    ...
    private void SetearDatosContacto() {
        ...
        Nombre_C_D.setText("Nombre: " + nombres_c);
    ...
    private final ActivityResultLauncher<String> SolicitudPermisoLlamada =
    ...
    private final ActivityResultLauncher<String> SolicitudPermisoMensaje =
            registerForActivityResult(new ActivityResultContracts.RequestPermission(), isGranted -> {
                if (isGranted) {
                    EnviarMensaje();
                } else {
