...
public class Listar_Notas extends AppCompatActivity {
    ...
    private void ListarTodasNotas(){
        //consulta
        Query query = BD_Usuarios.child(user.getUid()).child("convocatorias").orderByChild("fecha_nota");
    ...
    private void ListarNotasFinalizadas(){
        ...
        Query query = BD_Usuarios.child(user.getUid()).child("convocatorias").orderByChild("estado").equalTo(estado_nota);
        options = new FirebaseRecyclerOptions.Builder<Nota>().setQuery(query, Nota.class).build();
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Nota, ViewHolder_Nota>(options) {
            @Override
            protected void onBindViewHolder(@NonNull ViewHolder_Nota viewHolder_nota, int position, @NotNull Nota nota) {
    ...
    private void EliminarNota(String id_nota) {
        ...
        builder.setPositiveButton("Si", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                //ELIMINAR NOTA EN BD
                Query query = BD_Usuarios.child(user.getUid()).child("convocatorias").orderByChild("id_nota").equalTo(id_nota);
    ...
    private void FiltrarNotas(){
        ...
        Todas_notas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                recreate();
                Toast.makeText(Listar_Notas.this, "Todas las convocatorias", Toast.LENGTH_SHORT).show();
        ...
        Notas_Finalizadas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                recreate();
                Toast.makeText(Listar_Notas.this, "Convocatorias finalizadas", Toast.LENGTH_SHORT).show();
                dialog_filtrar.dismiss();
            }
        });
        ...
        Notas_No_Finalizadas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                recreate();
                Toast.makeText(Listar_Notas.this, "Convocatorias no finalizadas", Toast.LENGTH_SHORT).show();
                dialog_filtrar.dismiss();
            }
        });
    ...
    private void Estado_Filtro(){
        sharedPreferences = Listar_Notas.this.getSharedPreferences("convocatorias", MODE_PRIVATE);
